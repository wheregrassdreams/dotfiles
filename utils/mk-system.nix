...
let
  ...
  commonArgs = {
    ...
    specialArgs = {
      ...
      inherit (inputs) nixpkgs nix-darwin home-manager sops-nix nixos-raspberrypi nixos-wsl nur lanzaboote nix-homebrew homebrew-core homebrew-cask apple-fonts apple-emoji-linux catppuccin catppuccin-themes hyprland dgop dms-cli dankMaterialShell yazi wezterm fenix affinity dotfiles-private;
    };
  };
